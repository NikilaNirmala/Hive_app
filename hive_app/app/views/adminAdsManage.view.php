            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="overflow-x-auto min-h-[350px]">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody>
                            <?php
                            if (isset($_SESSION['all_properties'])) {
                                foreach ($_SESSION['all_properties'] as $property) {
                                ...
                                <td class='p-2'>{$property['property_location']}, {$property['property_country']}</td>
                                <td class='p-2'>Rs:{$property['property_price']}.00</td>
                                <td class='p-2'>
                                    <form action='remove_ad' method='post'>
                                        <button name='ad_id' value='{$property['property_ID']}' type='submit'
